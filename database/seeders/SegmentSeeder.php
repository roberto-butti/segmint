...
class SegmentSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        // ----------------------------------
        // Segment 3: High intent (3+ visits)
        // ----------------------------------
        ...
        // ---------------------------------------
        // Segment 4: Marketing Campaign Visitors
        // ---------------------------------------
        ...
        // ----------------------------------------
        // Segment 5: Tech Interest (URL contains)
        // ----------------------------------------
        $tech = Segment::create([
            'project_id' => $project->id,
            'name' => 'Tech Interest',
